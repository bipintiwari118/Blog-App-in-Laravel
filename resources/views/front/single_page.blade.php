  ...
  <section class="section blog-wrap bg-gray">
              ...
              <ul class="comment-tree list-unstyled">
                  <li class="mb-5">
                      <div class="comment-area-box">
                          <img alt="" src="{{ asset('assets/front/images/blog/test1.jpg') }}" class="img-fluid float-left mr-3 mt-2">
                  ...
                  <li>
                      <div class="comment-area-box">
                          <img alt="" src="{{ asset('assets/front/images/blog/test2.jpg') }}" class="mt-2 img-fluid float-left mr-3">
      ...
      <div class="sidebar-widget latest-post card border-0 p-4 mb-3">
          ...
          <div class="media border-bottom py-3">
              <a href="#"><img class="mr-4" src="{{ asset('assets/front/images/blog/bt-3.jpg') }}" alt=""></a>
          ...
          <div class="media border-bottom py-3">
              <a href="#"><img class="mr-4" src="{{ asset('assets/front/images/blog/bt-2.jpg') }}" alt=""></a>
             <div class="media-body">
          ...
          <div class="media py-3">
              <a href="#"><img class="mr-4" src="{{ asset('assets/front/images/blog/bt-1.jpg') }}" alt=""></a>
              <div class="media-body">
